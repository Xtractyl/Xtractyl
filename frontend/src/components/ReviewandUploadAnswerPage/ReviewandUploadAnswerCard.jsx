// src/components/ReviewandUploadAnswerPage/ReviewandUploadAnswerCard.jsx
...
export default function UploadTasksCard({ apiToken }) {
  ...
  return (
    <div className="p-6 bg-[#e6e2cf] min-h-screen text-[#23211c]">
      <h1 className="text-2xl font-semibold mb-4">ReviewandUploadAnswersCard exists as a template</h1>
