  ...
  return (
    <div className="p-6 bg-xtractyl-background min-h-screen text-xtractyl-darktext">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
       ...
       {foldersError && <div className="text-sm text-xtractyl-orange">❌ {foldersError.message || "Failed to load folders."}</div>}
       ...
       {filesError && <div className="text-sm text-xtractyl-orange mt-2">❌ {filesError.message || "Failed to load files."}</div>}
